...
import { viewWithoutTokenCountry } from '../../api/master-data/country';
import {
  getAllStateByCountry,
  getAllStateByCountryWithoutToken,
} from '../../api/master-data/state';
...
export default function SelfRegister({
  ...
  const handleCorporateStatePopulate = (id, type) => {
    console.log('id', id);
    getAllStateByCountryWithoutToken(id)
      .then((res) => {
        if (res.data.success === true) {
  ...
  const handleFileInputChange = (event) => {
    ...
    // console.log(validFiles,">>>>>>>>>>>",newfiles);
