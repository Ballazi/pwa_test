...
const ShipperNameDisplayWrap = styled(Box)(({ theme }) => ({
  [theme.breakpoints.down('sm')]: {
    display: 'none',
  },
}));

export default function ShipperLayout(props) {
  ...
  const shipperLogo = localStorage.getItem('shipper_logo');
          ...
          <Toolbar>
            <Box sx={{ display: 'flex', alignItems: 'center', width: '60%' }}>
              ...
              >
                <img
                  src={
                    !shipperLogo || shipperLogo === 'null'
                      ? AcculeadImage
                      : `${baseUrl}/service/file/download/${shipperId}/logo/${shipperLogo}`
                  }
                  style={{ height: '45px' }}
                  alt="logo"
                />
              </Box>
              <ShipperNameDisplayWrap pl={3}>
                <Typography
                  color="secondary"
                  sx={{ fontSize: '16px', fontWeight: 500 }}
                >
                  {localStorage.getItem('shipper_name')}
                </Typography>
              </ShipperNameDisplayWrap>
            </Box>
        ...
        >
          ...
          <Sidebar rootStyles={rootStyles}>
            <SidebarMenu menuItemStyles={menuItemsStyles}>
              ...
              {tripManagement.some((x) => submoduleNames.includes(x)) && (
                <SubMenu
                  label="Trip Management"
                  rootStyles={subMenuStyles}
                  icon={<LocalShippingOutlined sx={{ height: '16px' }} />}
                >
                  {submoduleNames.includes('Create Trip') && (
                    <SidebarMenuItem
                  ...
                  {submoduleNames.includes('Manage Trip') && (
                    <SidebarMenuItem
                  ...
                  {submoduleNames.includes('Trip Reports') && (
                    <SidebarMenuItem
              ...
              {loadingManagement.some((x) => submoduleNames.includes(x)) && (
                <SubMenu
                  label="Loading Management"
                  rootStyles={subMenuStyles}
                  icon={<AssignmentTurnedInIcon sx={{ height: '16px' }} />}
                >
                  {submoduleNames.includes('Manage Loading') && (
                    <SidebarMenuItem
                  ...
                  {submoduleNames.includes('Loading Reports') && (
                    <SidebarMenuItem
                      // component={<Link to={`/${secured}/report`} />} />}
                      // active={location.pathname === `/${secured}/report`}
                      onClick={handleDrawerClose}
              ...
              {trackingManagement.some((x) => submoduleNames.includes(x)) && (
                <SubMenu
                  label="Tracking Management "
                  rootStyles={subMenuStyles}
                  icon={<MyLocationOutlined sx={{ height: '16px' }} />}
                >
                  {submoduleNames.includes('Create / Add Tracking') && (
                    <SidebarMenuItem
                      component={<Link to={`/${secured}/create-tracking`} />}
                      active={
                        location.pathname === `/${secured}/create-tracking`
                      }
                      onClick={handleDrawerClose}
                    >
                      Create / Add Tracking
                  ...
                  {submoduleNames.includes('Manage Tracking') && (
                    <SidebarMenuItem
                      component={<Link to={`/${secured}/manage-tracking`} />}
                      active={
                        location.pathname === `/${secured}/manage-tracking`
                      }
                      onClick={handleDrawerClose}
                    >
                      Manage Tracking
                  ...
                  {submoduleNames.includes('Alerts') && (
                    <SidebarMenuItem
                    // component={<Link to={`/${secured}/manage-tracking`} />}
                    // active={
                    //   location.pathname === `/${secured}/manage-tracking`
                  ...
                  {submoduleNames.includes('Tracking Reports') && (
                    <SidebarMenuItem
                      // component={<Link to={`/${secured}/report`} />}
                      // active={location.pathname === `/${secured}/report`}
                      onClick={handleDrawerClose}
              ...
              {delivery.some((x) => submoduleNames.includes(x)) && (
                <SubMenu
                  label="Delivery"
                  rootStyles={subMenuStyles}
                  icon={<Inventory2Outlined sx={{ height: '16px' }} />}
                >
                  {submoduleNames.includes('Epod') && (
                    <SidebarMenuItem
                  ...
                  {submoduleNames.includes('Epod pdf') && (
                    <SidebarMenuItem
                  ...
                  {submoduleNames.includes('Delivery Reports') && (
